    ...
    <div className="flex min-h-screen flex-col bg-black text-neutral-100">
        ...
        <div className="lg:hidden relative z-20 flex min-h-[calc(100vh-64px)] flex-col justify-between px-4 pb-12 pt-6 sm:pb-20 sm:pt-8 md:px-8 lg:px-16">
          ...
          <div className="mt-8 flex justify-center pb-4 sm:mt-6 sm:pb-0">
            <div className="flex flex-col items-center gap-2 text-sm text-neutral-100/70">
              <span className="text-xs uppercase tracking-[0.28em]">Details</span>
            ...
            <div className="flex flex-1 flex-col gap-6 sm:gap-8 md:flex-row md:items-start">
              <div className="max-w-xl pt-4 sm:pt-6 md:pt-10 lg:pt-16">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:gap-4">
                  <NeonButton
                    className="w-full border border-neon-pink/80 bg-black/40 px-8 py-3 text-sm sm:text-base font-semibold uppercase tracking-[0.4em] text-neon-pink shadow-[0_0_25px_rgba(92,255,181,0.3)] transition hover:border-neon-pink hover:bg-neon-pink/15 hover:text-white sm:w-auto"
                    href="/menu"
                  >
                    View Menu
                  </NeonButton>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={idx}
                className="group fade-up overflow-hidden rounded-lg border border-neon-pink/20 bg-black/40 transition-all hover:scale-[1.02] hover:border-neon-pink/40 hover:shadow-[0_0_20px_rgba(92,255,181,0.18)]"
              >
          ...
          <div className="mt-10 text-center">
            <Link className="inline-block text-sm font-semibold uppercase tracking-[0.3em] text-neon-teal transition hover:text-white sm:text-base" href="/menu">
              View Full Menu →
            </Link>
          </div>
        </div>
      ...
      <section className="border-b border-white/5 px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2 md:items-center">
          <div>
            <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.5em] text-neon-pink sm:text-xs">Events</p>
            ...
            <Link className="inline-block text-sm font-semibold uppercase tracking-[0.3em] text-neon-pink transition hover:text-white sm:text-base" href="/events">Host an Event →</Link>
          </div>
          ...
          <div className="relative h-48 overflow-hidden rounded-lg border border-neon-pink/20 bg-gradient-to-br from-neon-pink/5 via-transparent to-neon-teal/5 sm:h-64">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-xs uppercase tracking-[0.3em] text-neutral-400 sm:text-sm">Private Events</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-start">
            <div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <a className="rounded-full border border-neon-pink/60 bg-black/40 px-6 py-2.5 text-center text-xs font-semibold uppercase tracking-[0.3em] text-neon-pink transition hover:border-neon-pink hover:bg-neon-pink/10 sm:text-sm" href="tel:+911234567890">Call Us</a>
              </div>
            </div>
      ...
      <section className="border-t border-neon-teal/20 bg-black px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <NeonButton className="w-full border border-neon-pink/80 bg-black/40 px-10 py-3 text-sm font-semibold uppercase tracking-[0.32em] text-neon-pink shadow-[0_0_25px_rgba(92,255,181,0.22)] transition hover:border-neon-pink hover:bg-neon-pink/15 hover:text-white sm:w-auto" href="/reservations">
              Reserve a Table
            </NeonButton>

            <Link className="w-full rounded-full border border-neon-teal/60 bg-black/40 px-10 py-3 text-center text-sm font-semibold uppercase tracking-[0.32em] text-neon-teal transition hover:border-neon-teal hover:bg-neon-teal/10 hover:text-white sm:w-auto" href="/menu">
              View Menu
            </Link>
          </div>
        </div>
